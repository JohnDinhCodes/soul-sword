class DialogueModal extends Phaser.Plugins.ScenePlugin {
    ...
    animateText() {
        this.eventCounter++;
        this.text.setText(
            this.text.text + this.dialogue[this.eventCounter - 1]
        );
    ...
    createChoiceWindow() {
        const gameHeight1 = this.getGameHeight() - 45;
        const gameHeight2 = this.getGameHeight() - 80;
        const gameWidth = this.getGameWidth() - 400;
        const dimensions1 = this.calculateWindowDimensions(
            gameWidth,
            gameHeight1
        );
        const dimensions2 = this.calculateWindowDimensions(
            gameWidth,
            gameHeight2
        );
        dimensions1.x += 375;
        ...
        this.createOuterWindow(dimensions2);
